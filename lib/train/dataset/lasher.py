...
class LasHeR(BaseVideoDataset):
    ...
    def _get_sequence_path(self, seq_id):
        path = os.path.join(self.root, self.sequence_list[seq_id])
    ...
    def _get_frame_path(self, seq_path, frame_id):
        ...
        vis_img_files_v = sorted(glob(os.path.join(seq_path, 'visible', '*.jpg')))
        vis_img_files_i = sorted(glob(os.path.join(seq_path, 'infrared', '*.jpg')))
        try:
            rgb_frame_path = vis_img_files_v[frame_id]
        except:
            print(f"seq_path: {seq_path}")
            print(f"vis_img_files: {vis_img_files_v}")
            print(f"frame_id: {frame_id}")

        try:
            ir_frame_path = vis_img_files_i[frame_id]
        except:
            print(f"seq_path: {seq_path}")
            print(f"vis_img_files_i: {vis_img_files_i}")
            print(f"frame_id: {frame_id}")
        ...
        # print(rgb_frame_path, ir_frame_path)
    ...
    def get_frames(self, seq_id, frame_ids, anno=None):
        ...
        object_meta = OrderedDict({'object_class_name': None,
                                   ...
                                   'root_class': None,
                                   'motion_adverb': None})
        #print('lasherlasherlasherlasherlasherlasherlasherlasher')
